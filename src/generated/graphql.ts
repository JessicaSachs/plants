...
export type GetPlantersQuery = { readonly __typename?: 'Query', readonly app: { readonly __typename?: 'App', readonly planters: ReadonlyArray<{ readonly __typename?: 'Planter', readonly id: string, readonly name: string, readonly size: PlanterSizes, readonly lastFeedDate: string, readonly nextFeeding: { readonly __typename?: 'Feeding', readonly nextDate: string, readonly feedAmount: number, readonly interval: Maybe<number>, readonly overdue: boolean, readonly shouldClean: boolean, readonly id: string, readonly times: Maybe<number> }, readonly schedule: ReadonlyArray<{ readonly __typename?: 'Feeding', readonly nextDate: string, readonly feedAmount: number, readonly overdue: boolean, readonly interval: Maybe<number>, readonly shouldClean: boolean, readonly id: string, readonly times: Maybe<number> }> }> } };
